...
|---|---|---|
| `full` | wm.vercel.app | Geopolitics, military, OSINT, conflicts, markets |
| `tech` | tech.wm.vercel.app | AI/ML, startups, cybersecurity, developer tools |
| `finance` | finance.wm.vercel.app | Markets, trading, central banks, macro indicators |
