...
| Hostname | Variant |
| --- | --- |
| `tech.wm.vercel.app` | `tech` |
| `finance.wm.vercel.app` | `finance` |
| `commodity.wm.vercel.app` | `commodity` |
| `happy.wm.vercel.app` | `happy` |
| `wm.vercel.app` (default) | `full` |
...
Sentry captures unhandled exceptions and promise rejections in production, with environment-aware routing (production on `wm.vercel.app`, preview on `*.vercel.app`, disabled on localhost and Tauri desktop).
