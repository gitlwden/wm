...
| **😊 Happy Monitor** | [happy.wm.vercel.app](https://happy.wm.vercel.app) | Curated positive news, global progress tracking, science breakthroughs, conservation wins |
| **💰 Finance Monitor** | [finance.wm.vercel.app](https://finance.wm.vercel.app) | Global markets, stock exchanges, central banks, commodities, forex, crypto, economic indicators |
| **⛏️ Commodity Monitor** | [commodity.wm.vercel.app](https://commodity.wm.vercel.app) | Commodity markets, mining sites, processing plants, supply chains, trade flows |
| **⚡ Energy Monitor** | [energy.wm.vercel.app](https://energy.wm.vercel.app) | Oil & gas pipelines, storage facilities, tanker positions, chokepoints, energy infrastructure and shocks |
...
The finance variant ([finance.wm.vercel.app](https://finance.wm.vercel.app)) provides specialized layers for global financial markets and economic intelligence.
...
The commodity variant ([commodity.wm.vercel.app](https://commodity.wm.vercel.app)) focuses on mining, metals, energy commodities, and critical mineral supply chains.
...
The happy variant ([happy.wm.vercel.app](https://happy.wm.vercel.app)) curates positive news, human progress data, and uplifting stories.
