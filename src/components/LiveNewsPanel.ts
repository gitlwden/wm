...
export class LiveNewsPanel extends Panel {
  ...
  private get embedOrigin(): string {
    ...
    try { return new URL(getRemoteApiBaseUrl()).origin; } catch { return 'https://wm-worldmonitor.netlify.app'; }
  }
  ...
  private async renderDesktopEmbedAsync(force = false): Promise<void> {
    ...
    params.set('origin', this.youtubeOrigin || 'https://wm-worldmonitor.netlify.app');
