...
export class Panel {
  ...
  public showLocked(features: string[] = []): void {
    ...
    if (isDesktopRuntime()) {
      ctaBtn.addEventListener('click', () => void invokeTauri<void>('open_url', { url: 'https://wm-worldmonitor.netlify.app/pro' }).catch(() => window.open('https://wm-worldmonitor.netlify.app/pro', '_blank')));
    } else {
