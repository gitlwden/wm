  ...
  private getGateAction(reason: PanelGateReason): () => void {
    switch (reason) {
      ...
      case PanelGateReason.FREE_TIER:
        return () => window.open('https://wm.vercel.app/pro', '_blank');
      default:
        return () => {};
    }
  }
  ...
  async renderLayout(): Promise<void> {
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', 'https://wm-neon.vercel.app')}"
            ...
            <a href="${vHref('tech', 'https://wm-tech-gitlwd-projects.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('finance', 'https://wm-finance.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('commodity', 'https://wm-commodity-gitlwd-projects.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('energy', 'https://wm-energy-gitlwd-projects.vercel.app')}"
            ...
            <span class="variant-divider"></span>
            <a href="${vHref('happy', 'https://wm-happy-gitlwd-projects.vercel.app')}"
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        <div class="mobile-menu-footer-links">
          <a href="https://wm.vercel.app/pro" target="_blank" rel="noopener">Pro</a>
          <a href="https://wm.vercel.app/blog/" target="_blank" rel="noopener">Blog</a>
          <a href="https://wm.vercel.app/docs" target="_blank" rel="noopener">Docs</a>
          <a href="https://wm.vercel.app/" target="_blank" rel="noopener">Status</a>
        </div>
