 ...
 */
export const PRO_LAUNCH_FROM = "Elie from WorldMonitor <news@wm-worldmonitor.netlify.app>";
export const PRO_LAUNCH_REPLY_TO = "elie@wm-worldmonitor.netlify.app";
...
export const PRO_LAUNCH_UPGRADE_URL = "https://wm-worldmonitor.netlify.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email";
 ...
 */
export const PRO_LAUNCH_TEXT = `I'm Elie, founder of WorldMonitor. PRO launched today (https://wm-worldmonitor.netlify.app/pro). I'm writing because you signed up a month ago, when the product was smaller and different.
...
It grew a dedicated energy variant. energy.wm-worldmonitor.netlify.app: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.
...
Native AI context. MCP server plus a 27-endpoint REST API — full docs at https://wm-worldmonitor.netlify.app/docs/documentation. Plug it into Claude, ChatGPT, Cursor, or anything you're building.
...
→ Upgrade to PRO: https://wm-worldmonitor.netlify.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=launch-email
...
<p>I'm Elie, founder of WorldMonitor. <a href="https://wm-worldmonitor.netlify.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=opener" style="color:#0066cc;">PRO launched today</a>. I'm writing because you signed up a month ago, when the product was smaller and different.</p>
...
<p><strong>It grew a dedicated energy variant.</strong> <a href="https://energy.wm-worldmonitor.netlify.app" style="color:#0066cc;">energy.wm-worldmonitor.netlify.app</a>: live traffic and exposure on the four major shipping chokepoints, tanker positions in real time, 631 oil and gas pipelines mapped, global strategic storage atlas, refinery utilization, retail fuel prices.</p>
...
<p><strong>Native AI context.</strong> MCP server plus a 27-endpoint REST API — <a href="https://wm-worldmonitor.netlify.app/docs/documentation" style="color:#0066cc;">full docs</a>. Plug it into Claude, ChatGPT, Cursor, or anything you're building.</p>
<p>Also included:</p>
...
<a href="https://wm-worldmonitor.netlify.app/pro?utm_source=resend&utm_medium=email&utm_campaign=pro-launch&utm_content=cta-button" style="display:inline-block;background:#111;color:#ffffff;text-decoration:none;padding:14px 28px;border-radius:6px;font-weight:600;">Upgrade to PRO with EARLYWM30 →</a>
</p>
