...
const subscriptionStatus = v.union(v.literal("active"), v.literal("on_hold"), v.literal("cancelled"), v.literal("expired"));
// Payment event status enum — covers charge outcomes and dispute lifecycle
const paymentEventStatus = v.union(v.literal("succeeded"), v.literal("failed"), v.literal("dispute_opened"), v.literal("dispute_won"), v.literal("dispute_lost"), v.literal("dispute_closed"));
export default defineSchema({
    ...
    notificationChannels: defineTable(v.union(v.object({
        userId: v.string(),
    ...
    waveRuns: defineTable({
        ...
        status: v.union(v.literal("picking"), v.literal("segment-created"), v.literal("pushing"), v.literal("broadcast-created"), v.literal("sent"), v.literal("failed")),
