...
Detected by hostname (`tech.wm.vercel.app` → tech, `finance.wm.vercel.app` → finance, etc.) or localStorage on desktop. Controls: default panels, map layers, refresh intervals, theme, UI text. Variant change resets all settings to defaults.
