 ...
 * `wm.vercel.app/mcp-grant` to the api-subdomain consent flow at
 * `api.wm.vercel.app/oauth/authorize-pro` (U5).
 *
 * Flow:
 ...
 *
 * The redirect URL host is FIXED to `https://api.wm.vercel.app` —
...
const AUTHORIZE_PRO_URL = 'https://api.wm.vercel.app/oauth/authorize-pro';
