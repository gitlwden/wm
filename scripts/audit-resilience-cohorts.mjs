...
//
// Usage:
//   WORLDMONITOR_API_KEY=wm_xxx API_BASE=https://wm-worldmonitor.netlify.app \
...
if (!FIXTURE_PATH) {
  if (!API_BASE) {
    console.error('[audit-resilience-cohorts] API_BASE env var required (e.g. https://wm-worldmonitor.netlify.app), or FIXTURE=path.json for offline mode');
    process.exit(2);
  }
