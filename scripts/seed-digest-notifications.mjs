...
// like `RESEND_FROM_BRIEF=brief@wm-worldmonitor.netlify.app` can't re-introduce the bug
// that `.env.example` documents.
const RESEND_FROM =
  normalizeResendSender(
    process.env.RESEND_FROM_BRIEF ?? process.env.RESEND_FROM_EMAIL,
    'WorldMonitor Brief',
  ) ?? 'WorldMonitor Brief <brief@wm-worldmonitor.netlify.app>';
...
function formatDigest(stories, nowMs) {
  ...
  lines.push('View full dashboard \u2192 wm-worldmonitor.netlify.app');
  return lines.join('\n');
}
  ...
  <div style="max-width: 680px; margin: 0 auto;">
    ...
    <div style="background: #0d0d0d; padding: 32px 36px 0;">
            ...
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td style="width: 36px; height: 36px; vertical-align: middle;">
                  <img src="https://wm-worldmonitor.netlify.app/favico/android-chrome-192x192.png" width="36" height="36" alt="WorldMonitor" style="border-radius: 50%; display: block;" />
                </td>
      ...
      <div style="text-align: center; padding: 12px 0 36px;">
        <a href="https://wm-worldmonitor.netlify.app" style="display: inline-block; background: #4ade80; color: #0a0a0a; padding: 12px 32px; text-decoration: none; font-weight: 700; font-size: 12px; text-transform: uppercase; letter-spacing: 1.5px; border-radius: 3px;">Open Dashboard</a>
      </div>
    </div>
