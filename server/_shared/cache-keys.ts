...
export const BOOTSTRAP_TIERS: Record<string, 'slow' | 'fast'> = {
  ...
  economicStress: 'slow',
 fredVix: 'slow', fredHySpread: 'slow', fredIcsa: 'slow',
 fredMortgage: 'slow', fredFedFunds: 'slow', fred10y2y: 'slow',
 fredM2: 'slow', fredUnrate: 'slow', fredCpi: 'slow',
 fredDgs10: 'slow', fredWalcl: 'slow', fredGdp: 'slow',
